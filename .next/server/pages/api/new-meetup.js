...
async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    try {
      const data = req.body;
      const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect('mongodb+srv://jordan1234:jordan1234@cluster0.otme2.mongodb.net/meetups?retryWrites=true&w=majority');
      const db = client.db();
